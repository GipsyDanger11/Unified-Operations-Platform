/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: 8b033ae8bcdff47250aab04cc97769b3)
// Runtime types generated with workerd@1.20260212.0 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_API_URL: string;
		EMAILS: Service /* entrypoint EmailService from emails-service */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MONGO_URI" | "PORT" | "JWT_SECRET" | "MISTRAL_API_KEY" | "VITE_API_URL">> {}
}
